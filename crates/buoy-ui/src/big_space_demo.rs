use bevy::{color::palettes, prelude::*, transform::TransformSystem};
use big_space::{camera::CameraController, prelude::*, world_query::GridTransformReadOnly};
use buoy_core::prelude::GridPrecision;

pub(crate) fn plugin(app: &mut App) {
    app.add_systems(Startup, (setup, ui_setup))
